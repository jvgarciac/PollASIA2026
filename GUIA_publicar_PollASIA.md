...
- **Confirmación de envío:** por cómo funcionan los Apps Script, la página muestra "enviado" de forma optimista (no lee la respuesta del servidor). Por eso dejé **WhatsApp / Copiar / Descargar** como respaldo. Haz siempre una prueba real al inicio para confirmar que las filas llegan.
